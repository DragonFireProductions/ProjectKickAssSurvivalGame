...
public class Block
{
    ...
    void CreateQuad(Cubeside side)
    {
        ...
        //Used to see the individual quad being drawn as it was created
        //Not needed any longer by adding meshrenderer to parent
    ...
    public bool HasSolidNeighbour(int x, int y, int z)
    {
        ...
        if( x < 0 || y >= World.chunkSize ||
            y < 0 || y >= World.chunkSize ||
            z < 0 || y >= World.chunkSize)
